            ...
            <ul class="nav ace-nav">
                ...
                <li class="light-blue"><a data-toggle="dropdown" href="#"
                                          class="dropdown-toggle"> <img class="nav-user-photo"
                                                                        src="/resources/assets/avatars/user.jpg" alt="Jason's Photo" /> <span
                    ...
                    <ul
                        ...
                        <li class="divider"></li>
                        <li><a href="${pageContext.request.contextPath}/userinfo/logout.do"> <i class="icon-off"></i> 退出
    ...
    <div class="main-container-inner">
        ...
        <div class="sidebar" id="sidebar">
            ...
            <ul class="nav nav-list">
                <li class="active"><a href="/jsp/admin/main.jsp" target="mainframe"> <i
                ...
                <li><a href="javascript:void(0)" target="mainframe"
                    ...
                    <ul class="submenu">
                        ...
                        <li><a href="${pageContext.request.contextPath}/userinfo/list.do" target="mainframe"> <i
                                class="icon-double-angle-right"></i> 用户管理
                        </a></li>
                        <li><a href="/jsp/admin/viewinfo/viewinfo_add.jsp" target="mainframe"> <i
                                class="icon-double-angle-right"></i> 添加景区
                        </a></li>

                        <li><a href="${pageContext.request.contextPath}/viewinfo/list.do" target="mainframe"> <i
                                class="icon-double-angle-right"></i> 查询景区
                        </a></li>
                    </ul></li>
            </ul>
            <!-- /.nav-list -->
        ...
        <div class="main-content" id="mains">
            <iframe id="mainframe" name="mainframe" src="/jsp/admin/main.jsp"
